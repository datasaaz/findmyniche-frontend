    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h1 className="text-6xl font-thin text-gray-900 mb-4">About</h1>
      ...
      <section className="bg-essence py-8">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 lg:gap-16 opacity-80">
            <div className="text-4xl font-bold text-black">StartupCo</div>
            <div className="text-4xl font-bold text-black">VentureLab</div>
            <div className="text-4xl font-bold text-black">MarketPro</div>
            <div className="text-4xl font-bold text-black">BizInsight</div>
            <div className="text-4xl font-bold text-black">GrowthHub</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">About findmyniche</h2>
              <div className=" font-[20px] space-y-4 text-gray-700 leading-relaxed">
                <p>
                  findmyniche is the leading source of location-based market intelligence and
                  business opportunity insights for entrepreneurs, small businesses, and
                  enterprises across the globe.
                </p>
                <p>
                  Founded in 2025, findmyniche's market analysis platform has helped thousands
                  of entrepreneurs identify profitable niches and validate business ideas with
                  data-driven insights. Our platform provides visibility into market saturation,
                  demographics, competition, and economic indicators—empowering users to make
                  confident location-based business decisions.
                </p>
                <p>
      ...
      <section className="bg-gray-50 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Global Teams</h2>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Market Reports</h2>
      ...
      <section className="bg-gray-50 py-20 border-t border-gray-200">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Ready to discover your niche?</h2>
